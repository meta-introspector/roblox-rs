-- Simple Actor System for Roblox-RS
...
function ActorHandle:terminate()
    ...
    -- TODO: Additional cleanup for supervised actors, etc.
        ...
        if message.type == "monitor" then
            ...
            if restartCount <= state.maxRestarts then
                ...
                task.delay(state.restartDelay, function()
                    ...
                    -- Monitor the new child (not yet implemented fully)
                    -- Would need proper monitoring implementation
                end)
        ...
        elseif message.type == "forward" then
            ...
            if state.currentChild then
                ...
                if message._responseId then
                    -- For 'ask' pattern, we need to forward the response too
